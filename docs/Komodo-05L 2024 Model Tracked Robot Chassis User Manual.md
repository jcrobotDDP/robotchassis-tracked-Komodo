# <span style="color: #FF6B6B">Komodo-05L 2024 Model Tracked Robot Chassis User Manual</span>

<img width="640" height="360" alt="image" src="https://github.com/user-attachments/assets/30525bc9-41d8-4ab9-9dd7-b5ca09839b04" />
...
The KOMODO-05L is a high‑performance general‑purpose tracked robot chassis. The vehicle adopts a fully independent Christie suspension design, providing excellent stability and reliability for the whole vehicle. Equipped with high‑torque brushless motors, and through carefully matched chassis height and power configurations, this model delivers strong terrainability, a low centre of gravity, smooth operation, and high transmission efficiency, allowing it to navigate various complex terrains with ease.

With its high performance and stability, the KOMODO-05L general‑purpose tracked robot chassis provides a reliable mobile solution for robots operating in special environments. Whether in terms of terrainability, centre‑of‑gravity control, or transmission efficiency, this chassis demonstrates outstanding performance.

### 6.2 Technical Dimensions (Diagram)

<img width="963" height="620" alt="image" src="https://github.com/user-attachments/assets/28626546-c64c-4940-9211-d17648d731ee" />
...
| :--- | :---: | :--- | :---: |
| Overall dimensions (mm) | 1430 × 945 × 540 | Internal compartment size (including battery compartment) | 1190 × 490 × 314 |
| Chassis weight (unloaded) | 390 kg | Operating speed | 0 – 5.4 km/h |
| Ground clearance | 140 mm | Protection rating | IP64 |
| Max gap crossing | 250 mm | Maximum payload | 310 kg |
| Max climbing angle | 30° | Vertical obstacle clearance | 200 mm |
| Track material | Rubber (steel‑reinforced) | Track width | 150 mm |
| Suspension system | Christie‑type × 8 dampers | Main body material | Alloy steel plate / aluminium / polymer material |
| Surface finish | Black powder coating (matt) | Drive wheel diameter | 310 mm |
...
| Max total power | 3 kW × 2 | Standby power consumption | ≤ 50 W |
| Encoder (optional) | 1024 P | Driver model | 48150‑2E |
| Remote control range | 200 m (external antenna) | Remote control channels | 9T (2 used) |
| Chassis total weight | 275 kg | Chassis total current | 60 A |

| **Driver** | | | |
| :--- | :--- | :--- | :--- |
| Power input | 24‑60 V | Operating mode | Speed open‑loop / speed closed‑loop |
| Continuous current | 80 A | Peak current | 150 A |
| Controllable speed range | 50‑3000 RPM | Control accuracy | ± 0.1% @ 3000 RPM |
| Protection functions | Overcurrent, overtemperature, overvoltage, undervoltage, etc. | Control methods | Analogue, pulse width, RS232, CAN |
| Operating ambient temperature | -25°C to +55°C | | |

| **Battery** | | | |
| :--- | :--- | :--- | :--- |
| Nominal voltage | 48 V | Rated capacity | 80 Ah |
| Charge cut‑off | 54.6 V ± 0.2 V | Discharge cut‑off | 39 V |
| Discharge current | 200 A | Operating temperature | -10°C to +60°C (discharge), 0‑45°C (charge) |
...
| **VCU** | | | |
| :--- | :--- | :--- | :--- |
| Power supply | 12 V | Communication interfaces | S.BUS, CAN, RS232 |
| Expansion interfaces | RS485, analogue, digital (switch), TTL | Operating temperature | -40°C to 85°C |

---

### 6.5 Electrical Schematic

<img width="1060" height="796" alt="image" src="https://github.com/user-attachments/assets/07f1d9cf-8bb3-4176-b666-91f5ca6a6e51" />

a) **Battery**: Standard 48V 80Ah lithium battery, maximum voltage 54.6V, cut‑off discharge voltage 39V.  
...
b) **Driver operating conditions:** Temperature -25°C to +55°C, humidity ≤ 80% RH.  
...
c) **Receiver power:** Default power is supplied from the VCU, output 5V/20mA. If the receiver is used to drive high‑power loads, use an external 5V power supply.

---

### 6.6 Development Documentation

Development of this chassis requires the VCU hardware.
...
a. **Bearing replacement** – Wheel assembly bearing replacement: If the wheel assemblies become noisy or jammed, replace the bearings with model 3306A.

b. **Track replacement:**

- Power off the entire vehicle completely.
- Raise the entire chassis so that the tracks are naturally relaxed and at least 100 mm above the ground, fully suspended and not in contact with any object.
- Loosen the tension arm fixing screws to the free state.
- Loosen the tensioning screws to the free state.
- Remove the shoulder bolts connecting the front swing arm shock absorber to the tension arm, and release the shock absorber.
- Allow the front swing arm to hang down in a relaxed state.
- Remove the old track, install the new track, and reassemble the entire suspension in the reverse order.
- Tighten the tensioning studs to a length equivalent to 6‑8 threads of engagement.

**Note:** Do not apply thread‑locking compound to the tension arm fixing screws.

<img width="1100" height="605" alt="image" src="https://github.com/user-attachments/assets/eff51081-0014-48eb-abe1-911999889bbf" />
...
1) **Packaging dimensions:** Minimum carton approx. [blank in original] mm.

2) **Handling requirements:**

a. The chassis is packed in a wooden crate with a wooden pallet base; total mass [blank in original] kg. Use a pallet jack or forklift to move the pallet. When moving, do not tilt the crate more than 15 degrees. Ensure the fork fully supports the pallet to prevent tipping due to uneven centre of gravity. **Do not lift by the top cover or side panels** – the pallet may detach and damage the chassis.
...
<img width="2037" height="952" alt="image" src="https://github.com/user-attachments/assets/4bdfa118-66af-4228-b2bd-6b0307d2476a" />

*Please open this page in a browser and download:*

[K05L_Customer_Communication_231229001.rar](https://www.yuque.com/attachments/yuque/0/2024/rar/35546837/1717578642337-3694405c-efaa-4783-a307-3f0cec17bb41.rar)

There are many variants derived from this chassis model. For other models or customisation requirements, please contact us.
...
> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/nw67iblguaww3ame?singleDoc# 《Firefighting Robot Data K-05L & K-10》](http://invalid.uri)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/gf1mmt85zna7gg6t](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/gf1mmt85zna7gg6t)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/nneifetclatdehu0](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/nneifetclatdehu0)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/hifab87ukc1yhzi6](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/hifab87ukc1yhzi6)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/singh08ne1lnzenu](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/singh08ne1lnzenu)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/gg1fc2ud8f34lklw](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/gg1fc2ud8f34lklw)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/spgo6e8s7gwowteu](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/spgo6e8s7gwowteu)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/ht75e8gvoduohy47](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/ht75e8gvoduohy47)
