# <span style="color: #FF6B6B">Komodo-03 Tracked Robot Chassis User Manual</span>
...
The KOMODO-03 is a general‑purpose tracked robot chassis featuring a dual‑motor differential drive system with brushless DC motors and drivers. The motors are equipped with encoders, and the drivers offer comprehensive communication interfaces. This chassis is fully featured and highly integrated, with various configurable options to suit multiple operating conditions. The independently developed suspension delivers excellent torsional strength and lateral rigidity, providing outstanding stability, mobility, and high terrainability. The standard power lithium battery is 48V 30Ah (48V 50Ah or custom options available), with a BMS battery protection system. The 150mm wide tracks offer strong terrain adaptability and require minimal maintenance. The exterior housing has been carefully designed with industrial aesthetics, facilitating the installation of various electrical equipment. This chassis is suitable for all application scenarios where tracked chassis are used, and can be widely applied in special‑purpose robot industries such as reconnaissance, inspection, exploration, scientific research, and education.

### 6.2 Technical Dimensions (Diagram)

<img width="1589" height="947" alt="image" src="https://github.com/user-attachments/assets/fbe0fc1d-17f3-445a-8db0-2346df7f125b" />
...
**1) Optional 2×1500W motors**

| Parameter | Value | Parameter | Value |
| :--- | :---: | :--- | :---: |
| Overall dimensions (L×W×H) | 1190 × 765 × 435 mm | Internal compartment size (L×W×H) | 490 × 360 × 205 mm (without battery) |
| Rated power | 2 × 1500 W | Motor voltage | 48 V |
| Reducer gear ratio | 14.92 | Operating speed | 0‑6.2 km/h (minimum fine‑tune speed 0.6 km/h) |
| Chassis weight (unloaded) | 155 kg | Rated payload | 125 kg |
| Ground clearance | 185 ± 10 mm (depends on load) | Rated obstacle clearance | 145 mm (depends on centre of gravity) |
| Max climbing angle | 30° | Rated gap crossing | 210 mm (depends on centre of gravity) |
...
**2) Optional 2×2000W motors (requires heavy‑duty shock absorbers; higher track detachment probability)**

| Parameter | Value | Parameter | Value |
| :--- | :---: | :--- | :---: |
| Overall dimensions (L×W×H) | 1190 × 765 × 435 mm | Internal compartment size (L×W×H) | 470 × 370 × 210 mm (without battery) |
| Rated power | 2 × 2000 W | Motor voltage | 48 V |
| Reducer gear ratio | 12.47 | Operating speed | 0‑7.3 km/h (minimum fine‑tune speed 0.7 km/h) |
| Chassis weight (unloaded) | 160 kg | Rated payload | 145 kg (on flat terrain) |
| Ground clearance | 185 ± 10 mm (depends on load) | Rated obstacle clearance | 145 mm (depends on centre of gravity) |
| Max climbing angle | 30° | Rated gap crossing | 210 mm (depends on centre of gravity) |
| Suspension system | Left/right independent, total 8 oil‑damped shock absorbers | Track material | High‑quality rubber with embedded Kevlar fibres |
| Track width | 150 mm | Protection rating | IP54 (upgradeable to IP64) |
...
| Max total power | 1.5‑2 kW × 2 | Standby power consumption | ≤ 50 W |
| Encoder | 1024 P | Driver model | 4875‑2E / 48100‑2E |
| Remote control range | 200 m (external antenna) | Remote control channels | 9T |
| Chassis total weight | 155 kg | Chassis total current | 28 A |

| **Driver** | | | |
| :--- | :--- | :--- | :--- |
| Power input | 10‑55 V | Operating mode | Speed open‑loop / speed closed‑loop |
| Continuous current | 40 A / 50 A | Peak current | 75 A / 100 A |
...
<img width="1068" height="800" alt="image" src="https://github.com/user-attachments/assets/1914cdfd-60f0-435f-b73b-12162485f3e2" />
...
c) **Main relay:** Coil voltage 24V, main contact current 150A, normal temperature rise 60°C.
...
<img width="1153" height="719" alt="image" src="https://github.com/user-attachments/assets/8378f5e9-ae03-447f-aab3-8a4f3a5b75d8" />
...
b. **Adjustment:** Regularly inspect all fasteners for tightness; check for loose or missing screws to ensure safety, reliability, and control accuracy.

c. **Safety:** Regularly verify that controls are responsive and reliable, and that active and passive safety devices (such as collision bumpers, emergency stop switches, service brakes, parking brakes, and steering controls) operate correctly.
...
**1) Packaging dimensions:** Minimum cardboard carton approx. 1260 × 820 × 590 mm.

**2) Handling requirements:**

a. The chassis is packed in a wooden crate with a wooden pallet base; total mass ~200 kg. Use a pallet jack or forklift to move the pallet. When moving, do not tilt the crate more than 15 degrees. Ensure the fork fully supports the pallet to prevent tipping due to uneven centre of gravity. **Do not lift by the top cover or side panels** – the pallet may detach and damage the chassis.
...
<img width="1694" height="1077" alt="image" src="https://github.com/user-attachments/assets/8b7f9bbf-c851-4073-a3ed-0e85624c136c" />

*Please open this page in a browser and download:*

[KOMODO-03_Customer_Communication.rar](https://www.yuque.com/attachments/yuque/0/2023/rar/2802136/1686794349935-fc6e8ea1-f5dc-4a2a-b13c-362ea6570246.rar)

*Top cover actual hole positions:*

[KOMODO-03_Standard_Hole_Positions_2024.06.26.PDF](https://www.yuque.com/attachments/yuque/0/2024/pdf/35546073/1719385070688-10c43b4d-6e52-4239-a32d-3ce9149ffddb.pdf)
