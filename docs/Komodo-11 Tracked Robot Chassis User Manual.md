# <span style="color: #FF6B6B">Komodo-11 Tracked Robot Chassis User Manual</span>

<img width="640" height="360" alt="image" src="https://github.com/user-attachments/assets/f1f4a4fc-5fc6-4a48-adf9-f310166ca489" />
...
The KOMODO‑11 is a general‑purpose tracked robot chassis. The vehicle features a single‑side track drive design, with each side equipped with its own independent power supply and motor system, providing high space utilisation. With appropriately matched chassis height and power configuration, this model delivers strong terrainability, a low centre of gravity, smooth operation, and high transmission efficiency. It is suitable for mobile equipment solutions across various industries and can be equipped with different attachments as needed, with quick‑change capability. Applications include information broadcasting platforms, reconnaissance and search platforms, medical evacuation platforms, mine‑clearing platforms, UAV deployment platforms, lifting platforms, and other equipment.

---

### 6.2 Technical Dimensions (Diagram)

<img width="1094" height="858" alt="image" src="https://github.com/user-attachments/assets/b9d5db70-67c9-44d9-bede-93b51a52f3eb" />
...
| :--- | :---: | :--- | :---: |
| Overall dimensions (L×W×H) | 1990±30 × 1710±10 × 890±25 mm | Internal compartment size (L×W×H) | 1460 × 945 × unrestricted height |
| Rated power | 2 × 15000 W | Motor voltage | 96 V |
| Reducer gear ratio | 12 | Operating speed | 0 – 15 km/h |
| Chassis weight (unloaded) | 900 kg | Rated payload | 500 kg |
| Ground clearance | 255±25 mm (depends on load) | Rated obstacle clearance | 400 mm |
| Max climbing angle | 30° | Rated gap crossing | 390 mm (depends on centre of gravity) |
...
| Track width | 280 mm | Protection rating | IP54 (upgradeable to IP64) |
...
| Parameter | Value | Parameter | Value |
| :--- | :---: | :--- | :---: |
| Supply voltage | DC 96 V | Motor type | Brushless DC motor |
| Max total power | 15 kW × 2 | Standby power consumption | ≤ 100 W |
| Encoder (optional) | Magnetic encoder | Driver model | AE1618 |
| Remote control range | 200 m (line‑of‑sight) | Remote control channels | – |

---

### 6.5 Electrical Schematic

<img width="1014" height="761" alt="image" src="https://github.com/user-attachments/assets/a2b4406a-9291-47e3-967e-97d766541155" />

a) **Battery**: Standard 96V 100Ah lithium batteries × 2, maximum voltage 117V, cut‑off discharge voltage 85V.  
...
c) **Main relay:** Coil voltage 12V, main contact current 300A, normal temperature rise 60°C.
...
c. When recommissioning the chassis, ensure all parts are well lubricated. The gearbox grease replacement interval is two years; this requires disassembly of the tracks and drive wheels. Please perform this operation under remote guidance from the manufacturer or return the unit to the factory for maintenance.

**3) Replacement of wear parts and accessories**

a. **Bearings:** If wheel assemblies become loose, noisy, or jammed, replace the bearings with the same model. Front and rear load‑bearing wheels and tension wheel bearings are model 3305‑2RS; intermediate load‑bearing wheel bearings are model 3304‑2RS (2 pieces per assembly).

b. **Tracks:** Replace the tracks when wear no longer meets user requirements.
...
**1) Packaging dimensions:** Minimum crate approx. 2000 × 1800 × 1200 mm.
...
<img width="1641" height="970" alt="image" src="https://github.com/user-attachments/assets/090d5886-2a26-41c6-a3f6-1cde50c71940" />

*Please open this page in a browser and download:*

[Komodo-11_Tracked_Robot_Chassis_Model.rar](https://www.yuque.com/attachments/yuque/0/2023/rar/2802136/1686789068823-d1f2afde-d319-4800-831d-be2f296b86f6.rar)

<img width="1063" height="654" alt="image" src="https://github.com/user-attachments/assets/d2e7c567-f58f-46fb-b150-03d66786d6a6" />

*Please open this page in a browser and download:*

[📎2024.09.29_k11_External.rar](https://www.yuque.com/attachments/yuque/0/2024/rar/35546073/1727588860434-cbabe891-3c72-4080-b749-8a743f0f7e61.rar)
...
> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/igo8yigbdpr4vzc9](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/igo8yigbdpr4vzc9)
