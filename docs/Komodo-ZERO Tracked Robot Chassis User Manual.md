# Komodo-ZERO Tracked Robot Chassis User Manual

## Introduction

Welcome to the Komodo-ZERO Tracked Robot Chassis User Manual.
...
### Product Images
![Komodo-ZERO Front View](../Product%20pictures/placeholder-komodo-zero.jpg)
