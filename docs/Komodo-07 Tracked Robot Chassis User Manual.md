# <span style="color: #FF6B6B">Komodo-07 Tracked Robot Chassis User Manual</span>

<img width="640" height="360" alt="image" src="https://github.com/user-attachments/assets/4025cc8c-a289-43e0-ada0-85e1a02f06a4" /> <img width="640" height="360" alt="image" src="https://github.com/user-attachments/assets/4b7e638b-0292-4846-a898-b140fb727196" />
...
The KOMODO-07 is a general‑purpose customisable tracked robot chassis. It adopts a dual‑motor differential drive system, equipped with DC motors and drivers. The motors are fitted with encoders, and the drivers offer comprehensive communication interfaces. This chassis is fully featured and highly integrated, with various customisable configurations to suit multiple operating conditions. The independently developed suspension system delivers excellent torsional strength and lateral rigidity, providing outstanding stability and handling performance for the whole vehicle, along with superior off‑road capability.

The customised power lithium battery is equipped with a BMS battery protection system. Engineering‑grade tracks are selected for strong terrain adaptability and low maintenance. The exterior can be customised with industrial design upon request. This chassis is suitable for all applications where heavy‑duty tracked chassis are required, and can be widely used in special‑purpose robot industries such as reconnaissance, inspection, exploration, scientific research, and education.

---

### 6.2 Technical Dimensions and 6.3 Mechanical Specifications

#### A. Small Model – Komodo-07‑S

<img width="1532" height="1010" alt="image" src="https://github.com/user-attachments/assets/46b956c4-352b-4a90-beab-8cd4e88644d5" />

| Parameter | Value | Parameter | Value |
| :--- | :---: | :--- | :---: |
| Overall dimensions (L×W×H) | 1280±20 × 795±5 × 500±5 mm | Internal compartment size (L×W×H) | 780 × 300 × 380 mm (excluding battery) |
| Rated power | 2 × 4000 W | Motor voltage | 48 V |
| Reducer gear ratio | 20 | Operating speed | 0 – 4.2 km/h |
| Chassis weight (unloaded) | 400 kg (excluding battery) | Rated payload | 550 kg |
| Ground clearance | 95±5 mm | Rated obstacle clearance | 235 mm |
| Rated climbing angle | 30° (power capability sufficient; depends on ground friction coefficient) | Rated gap crossing | 265 mm (depends on centre of gravity) |
| Suspension system | Rocker‑arm type | Track material | High‑quality rubber with embedded steel wire and steel plate |
| Track width | 150 mm | Protection rating | IP54 (upgradeable to IP64) |

*Note: Overall dimensions, power, speed, payload, etc. are all customisable.*

---

#### B. Medium Model – Komodo-07‑M

<img width="1450" height="894" alt="image" src="https://github.com/user-attachments/assets/c31ab6f0-cd69-4db0-b3ae-2043d67af676" />

| Parameter | Value | Parameter | Value |
| :--- | :---: | :--- | :---: |
| Overall dimensions (L×W×H) | 1550±30 × 1210±5 × 535±5 mm | Internal compartment size (L×W×H) | 780 × 300 × 380 mm (excluding battery) |
| Rated power | 2 × 6000 W | Motor voltage | 72 V |
| Reducer gear ratio | 25.259 | Operating speed | 0 – 6.5 km/h |
| Chassis weight (unloaded) | 450 kg (excluding battery and any payload mounting plates) | Rated payload | 700 kg |
| Ground clearance | 140±5 mm | Rated obstacle clearance | 235 mm |
| Rated climbing angle | 30° (power capability sufficient; depends on ground friction coefficient) | Rated gap crossing | 335 mm (depends on centre of gravity) |
| Suspension system | Rocker‑arm type | Track material | High‑quality rubber with embedded steel wire and steel plate |
| Track width | 180 mm | Protection rating | IP54 (upgradeable to IP64) |
...
| Parameter | 07S | 07M |
| :--- | :---: | :---: |
| Supply voltage | DC 48 V | DC 72 V |
| Max total power | 4 kW × 2 | 6.9 kW × 2 |
| Standby power consumption | ≤ 50 W | ≤ 50 W |
| Encoder (optional) | 1024 P | 2500 P |
| Motor type | Brushless DC motor | Permanent magnet synchronous motor |
| Driver model | 48150‑2E | APT1618 |
| Remote control channels | 9T (2 used) | |
| Remote control range | 200 m (external antenna) | |

---

### 6.5 Electrical Schematic

<img width="1288" height="910" alt="image" src="https://github.com/user-attachments/assets/6db067fb-c7ce-4721-805b-e66b684e3c94" />

a) **Battery**: Standard lithium battery – maximum voltage and cut‑off voltage are configuration‑dependent (please refer to the specific battery specification).  
**Note:** Use the dedicated lithium battery charger. Battery failure caused by over‑discharge is not covered under warranty.

b) **Driver operating conditions:** Temperature -20°C to +60°C, humidity ≤ 80% RH.  
...
c) **Main relay:** Coil voltage 72V; main contact current is configuration‑dependent; normal temperature rise 60°C.
...
b. **Lubrication:** Customised products may have different reducers; please consult us for specific lubrication methods. For standard products, change the oil after the first 150 operating hours, and thereafter every 1000 hours, but at least once a year. Gears and bearings are splash‑lubricated – fill with oil to the specified level (approximately half the reducer volume). When changing oil, keep the system clean to avoid contamination. Recommended lubricant: L‑CKD220 (at 40°C) closed‑gear industrial oil, or an alternative grade approved by JCROBOT based on operating temperature. Apart from regular oil changes, the reducer requires no additional maintenance.
...
a. **Bearings:** If wheel assemblies become loose, noisy, or jammed, replace the bearings with the same model as the original.
...
1) **Packaging dimensions:** Minimum carton dimensions are configuration‑dependent.

2) **Handling requirements:**

a. The chassis is packed in a wooden crate with a wooden pallet base; total mass is configuration‑dependent. Use a pallet jack or forklift to move the pallet. When moving, do not tilt the crate more than 15 degrees. Ensure the fork fully supports the pallet to prevent tipping due to uneven centre of gravity. **Do not lift by the top cover or side panels** – the pallet may detach and damage the chassis.
...
<img width="1354" height="746" alt="image" src="https://github.com/user-attachments/assets/34bd3b31-bd7c-4f50-a5a8-32c336326104" />

*Please open this page in a browser and download:*

[Small_Komodo-07-S.rar](https://www.yuque.com/attachments/yuque/0/2023/rar/2802136/1687160372175-733c54d8-8486-4630-9f75-d233c86be2b3.rar)

<img width="1240" height="712" alt="image" src="https://github.com/user-attachments/assets/4d68a03e-9a88-4822-9738-e263b77f44ac" />

*Please open this page in a browser and download:*

[K07M_Customer_Communication_2025.06.07.rar](https://www.yuque.com/attachments/yuque/0/2025/rar/35546073/1749280961683-7a460ee7-e356-4690-87a4-6821fc66cd46.rar)
...
> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/bx2286rqiz3ttiud](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/bx2286rqiz3ttiud)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/gqnc616ma4mec7v2](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/gqnc616ma4mec7v2)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/qglcridee4yvzk5x](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/qglcridee4yvzk5x)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/octvmmv544o35gxx](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/octvmmv544o35gxx)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/pbstkmqq5t0mrndo](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/pbstkmqq5t0mrndo)
