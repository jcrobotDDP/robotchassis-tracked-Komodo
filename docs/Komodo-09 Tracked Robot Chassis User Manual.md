# <span style="color: #FF6B6B">Komodo-09 Tracked Robot Chassis User Manual</span>

<img width="640" height="360" alt="image" src="https://github.com/user-attachments/assets/ed7366d8-45b7-413b-bea2-2349115b3d31" />
...
The KOMODO-09 is a general‑purpose electric tracked robot chassis specifically developed for agricultural applications.

It adopts a dual‑motor differential drive system equipped with a high‑power electric drive system and comprehensive communication interfaces. The independently developed suspension delivers excellent torsional strength and lateral rigidity, providing outstanding stability and handling performance for the whole vehicle, specifically designed for muddy farmland environments. The power lithium battery is equipped with a BMS battery protection system. Engineering‑grade tracks are selected for strong terrain adaptability and low maintenance.

Key features for agricultural applications include:

1. Utilises standard engineering tracks and integrally cast wheel systems; all component modules are individually waterproofed; integrated frame design keeps overall cost relatively low.

2. Simple structure – all designs are validated through simulation calculations; simple and durable, with high system redundancy, reducing the risk of overloading in muddy conditions or when entangled with crop residue.

3. Flexible electric drive system configuration – supports up to 30 kW (dual‑side power) electric drive systems, and can also be configured with lower‑power electric drive systems.

4. The system has undergone thousand‑kilometre‑level testing with iterative optimisation of structural strength.

---

### 6.2 Technical Dimensions (Diagram)

<img width="1587" height="930" alt="image" src="https://github.com/user-attachments/assets/9abc140f-7ec1-4848-aa76-4185e4dc7c74" />
...
| :--- | :---: | :--- | :---: |
| Overall dimensions (L×W×H) | 2020±5 × 1000±5 × 610±5 mm | Internal compartment size (L×W×H) | 1450 × 430 × 300 mm (excluding battery) |
| Rated power | 2 × 10000 W | Motor voltage | 96 V / 72 V |
| Reducer gear ratio | 34 | Operating speed | 0 – 4.5 km/h |
| Chassis weight (unloaded) | 600 kg (excluding battery) | Rated payload | 1050 kg |
| Ground clearance | 210 ± 10 mm | Rated obstacle clearance | 200 mm (upgradeable to 300 mm) |
| Rated climbing angle | 20° (power capability sufficient; depends on ground friction coefficient) | Rated gap crossing | 380 mm (depends on centre of gravity) |
| Suspension system | Rocker‑arm type | Track material | High‑quality rubber with embedded steel wire and steel plate |
| Track width | 200 mm | Protection rating | IP54 (upgradeable to IP64) |
...
| Parameter | Value | Parameter | Value |
| :--- | :---: | :--- | :---: |
| Supply voltage | DC 96 V | Motor type | Permanent magnet synchronous motor |
| Max total power | 10 kW × 2 | Standby power consumption | ≤ 50 W |
| Encoder (optional) | Magnetic encoder | Driver model | Customised / matched accordingly |
...
<img width="1025" height="769" alt="image" src="https://github.com/user-attachments/assets/43b9c918-19b2-4338-8235-403af1f34604" />

a) **Battery**: Standard 96V lithium battery, maximum voltage 117V, cut‑off discharge voltage 96V.  
...
c) **Main relay:** Coil voltage 96V, main contact current 400A, normal temperature rise 60°C.
...
**1) Packaging dimensions:** Minimum cardboard carton dimensions are configuration‑dependent.

**2) Handling requirements:**

a. The chassis is packed in a wooden crate with a wooden pallet base; total mass ~700 kg. Use a pallet jack or forklift to move the pallet. When moving, do not tilt the crate more than 15 degrees. Ensure the fork fully supports the pallet to prevent tipping due to uneven centre of gravity. **Do not lift by the top cover or side panels** – the pallet may detach and damage the chassis.
...
<img width="1385" height="743" alt="image" src="https://github.com/user-attachments/assets/d07efd97-6271-41cf-89d6-992cfeb7434f" />

*Please open this page in a browser and download:*

[K09_Tracked_Chassis_Customer_Communication_2023.09.01.rar](https://www.yuque.com/attachments/yuque/0/2023/rar/35546073/1693558824375-e1d54dc0-6c6c-456a-ac71-4ba3b33d975a.rar)

[Komodo-09_Tracked_Robot_Chassis_User_Manual.docx](https://www.yuque.com/attachments/yuque/0/2024/docx/2802136/1727174400794-d7cfdcd6-4575-4b76-b44c-f63bdde08252.docx)
...
> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/gksfkcpd75fmd25f](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/gksfkcpd75fmd25f)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/yi04z2oohzse1liw](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/yi04z2oohzse1liw)
