...
The KOMODO-01 is a general‑purpose tracked robot chassis that combines advanced performance with precision engineering. Its dual‑motor differential drive system uses brushless DC motors and precise encoders to achieve accurate driving and superior motion control. The chassis features comprehensive communication interfaces and various configurable options, making it suitable for a wide range of operating conditions and providing flexible expansion capabilities for diverse applications.

The chassis's unique suspension system has been independently developed, offering excellent torsional strength and lateral rigidity, providing outstanding stability and precise suspension tuning for the whole vehicle, allowing it to navigate complex terrains with ease.

The KOMODO-01 is equipped with a 48V 30Ah lithium battery as standard (48V 50Ah or custom options available), with a BMS battery management system. The 150mm wide high‑wear‑resistant tracks provide excellent terrain adaptability while minimising maintenance requirements, offering users a more convenient experience. In terms of appearance, the KOMODO-01 emphasises industrial aesthetics with a carefully designed shape that is both attractive and practical, facilitating the installation of various electrical equipment.

This chassis is suitable for all application scenarios where tracked chassis are used, and can be widely applied in special‑purpose robot industries such as reconnaissance, inspection, exploration, scientific research, and education.

### 6.2 Technical Dimensions (Diagram)

<img width="1540" height="941" alt="image" src="https://github.com/user-attachments/assets/17811460-1733-4133-a454-4c581d67f8e4" />
...
**1) Optional 2×785W motors**

| Parameter | Value | Parameter | Value |
| :--- | :---: | :--- | :---: |
| Overall dimensions (L×W×H) | 960×700×330 mm | Internal compartment size (L×W×H) | 300×260×230 mm (without battery) |
| Rated power | 2×785 W | Motor voltage | 48 V |
| Reducer gear ratio | 14.92 (nominal 15) | Operating speed | 0‑6.2 km/h (minimum fine‑tune speed 0.6 km/h) |
| Chassis weight (unloaded) | 105 kg | Rated payload | 65 kg |
| Ground clearance | 75±10 mm (depends on load) | Rated obstacle clearance | 125 mm (depends on centre of gravity) |
| Max climbing angle | 30° | Rated gap crossing | 160 mm (depends on centre of gravity) |
| Suspension system | Left/right independent, total 8 oil‑damped shock absorbers | Track material | High‑quality rubber with embedded Kevlar fibres |
| Track width | 150 mm | Protection rating | IP54 (upgradeable to IP64) |

---

**2) Optional 2×1000W motors (minimum width 650 mm)**

| Parameter | Value | Parameter | Value |
| :--- | :---: | :--- | :---: |
| Overall dimensions (L×W×H) | 960×700×330 mm | Internal compartment size (L×W×H) | 300×250×230 mm (without battery) |
| Rated power | 2×1000 W | Motor voltage | 48 V |
| Reducer gear ratio | 14.92 (nominal 15) | Operating speed | 0‑6.2 km/h (minimum fine‑tune speed 0.6 km/h) |
| Chassis weight (unloaded) | 110 kg | Rated payload | 90 kg |
| Ground clearance | 75±10 mm (depends on load) | Rated obstacle clearance | 125 mm (depends on centre of gravity) |
| Max climbing angle | 30° | Rated gap crossing | 160 mm (depends on centre of gravity) |
| Suspension system | Left/right independent, total 8 oil‑damped shock absorbers | Track material | High‑quality rubber with embedded Kevlar fibres |
| Track width | 150 mm | Protection rating | IP54 (upgradeable to IP64) |
...
**3) Optional 2×1500W motors**

| Parameter | Value | Parameter | Value |
| :--- | :---: | :--- | :---: |
| Overall dimensions (L×W×H) | 960×700×330 mm | Internal compartment size (L×W×H) | 300×230×230 mm (without battery) |
| Rated power | 2×1500 W | Motor voltage | 48 V |
| Reducer gear ratio | 12.47 (nominal 12.5) | Operating speed | 0‑7.3 km/h (minimum fine‑tune speed 0.7 km/h) |
| Chassis weight (unloaded) | 135 kg | Rated payload | 110 kg |
| Ground clearance | 75±10 mm (depends on load) | Rated obstacle clearance | 160 mm |
| Max climbing angle | 30° | Rated gap crossing | 160 mm (depends on centre of gravity) |
| Suspension system | Left/right independent, total 8 oil‑damped shock absorbers | Track material | High‑quality rubber with embedded Kevlar fibres |
| Track width | 150 mm | Protection rating | IP54 (upgradeable to IP64) |

**Note:** The reducer gear ratio can also be changed to increase speed (for the same motor, higher speed will reduce payload capacity).
...
| **Battery** | | | |
| :--- | :--- | :--- | :--- |
| Nominal voltage | 48 V | Rated capacity | 30 Ah |
| Charge cut‑off | 54.6 V ± 0.2 V | Discharge cut‑off | 39 V |
| Discharge current | 60 A | Operating temperature | -10°C to +60°C (discharge), 0‑45°C (charge) |
...
<img width="1064" height="798" alt="image" src="https://github.com/user-attachments/assets/560b37a4-33b6-4032-a05a-c12d94c102ea" />
...
b. **Lubrication:**  
1. The reducer is factory‑filled with ISO VG220 mineral lubricating oil; no initial refill is needed. After the first 300 operating hours (gear break‑in period), change the lubricating oil; thereafter, change every 6000 hours. Do not mix oils of different grades; oils of the same grade but different viscosities may be mixed. Oil should be added while the reducer is stopped; fill to about 3/4 of the reducer's internal volume (approximately 0.22 L). Factory fill: ISO VG220.  
<img width="1153" height="719" alt="image" src="https://github.com/user-attachments/assets/834a5ca0-cd31-4745-bb40-d661210bfd51" />

2. Inspect oil quality every six months; if impurities, ageing, or deterioration are found, replace immediately.  
3. The maximum allowable oil temperature for the reducer is 85°C; if exceeded, stop and inspect.  
4. It is recommended to test reducer performance every two years and replace the internal bearing grease.
...
c. When recommissioning the chassis, ensure all parts are well lubricated. If the reducer has been stored for more than 4 months, or after 6000 operating hours, or after six months of use (whichever comes first), check whether the oil seal is immersed in lubricating oil. The oil seal lip may stick to the shaft and lose elasticity. Proper elasticity is essential for normal oil seal function; replace the oil seal if it loses elasticity.

**3) Replacement of wear parts and accessories**

a. **Bearings:** If wheel assemblies become loose, noisy, or jammed, replace the bearings with the same model (61900, 4 pieces per wheel assembly).

b. **Tracks:** If the tread lugs are excessively worn and no longer meet user requirements, contact the manufacturer to purchase new tracks.
...
**1) Packaging dimensions:** Minimum cardboard carton approx. 1130 × 890 × 620 mm.

**2) Handling requirements:**

a. The chassis is packed in a wooden crate with a wooden pallet base; total mass ~160 kg. Use a pallet jack or forklift to move the pallet. When moving, do not tilt the crate more than 15 degrees. Ensure the fork fully supports the pallet to prevent tipping due to uneven centre of gravity. **Do not lift by the top cover or side panels** – the pallet may detach and damage the chassis.
...
<img width="2560" height="1668" alt="image" src="https://github.com/user-attachments/assets/1573b614-b0eb-4929-b9b6-93bf8562f336" />

*Please open this page in a browser and download:*

[K01_External_Assembly_202404.rar](https://www.yuque.com/attachments/yuque/0/2024/rar/35546073/1713665374939-6f425282-b63b-4a16-83a0-cce5ff202fc1.rar) (2024 version)

[komodo01-DAE.rar](https://www.yuque.com/attachments/yuque/0/2023/rar/2802136/1686206101501-8d58c3bd-9f89-4d7c-9f27-f9462fcd282f.rar) (DAE format for ROS system modelling and simulation)
...
> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/hi6q62gvl85nd2eu?singleDoc# 《Bulletproof Humanoid Target Tracked Vehicle Komodo-01》](http://invalid.uri)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/hcnfn4cm8gni10yn?singleDoc# 《Elevating Transport Robot Komodo-01》](http://invalid.uri)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/lbgt3vd4o4nb3dyu](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/lbgt3vd4o4nb3dyu)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/hdnd0nws7v2dugvi](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/hdnd0nws7v2dugvi)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/nogoedv6shnnvhru](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/nogoedv6shnnvhru)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/qm8g6ksevpevyx93](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/qm8g6ksevpevyx93)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/vqd7hb5zb6h2kyfg](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/vqd7hb5zb6h2kyfg)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/hi6q62gvl85nd2eu?singleDoc# 《Bulletproof Humanoid Target Tracked Vehicle Komodo-01》](http://invalid.uri)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/bc98mgrtypxb16n9?singleDoc# 《Komodo-01 Reconnaissance Robot (Bright Light + Camera)》](http://invalid.uri)
