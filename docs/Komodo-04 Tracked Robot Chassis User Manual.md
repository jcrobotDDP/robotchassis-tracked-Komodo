# <span style="color: #FF6B6B">Komodo-04 Tracked Robot Chassis User Manual</span>

<img width="5000" height="2813" alt="image" src="https://github.com/user-attachments/assets/637d3947-acb0-4385-8901-b719e74d3906" />
...
The KOMODO-04 is a medium‑duty tracked robot chassis featuring a Christie + Matilda four‑wheel‑group balanced suspension system, a proprietary track tension adjuster, and integrated drive wheels for smoother operation. Designed as a heavy‑duty robot chassis, it incorporates a reinforced suspension design to enhance overall rigidity, combined with long‑stroke oil‑damped shock absorbers – blending stiffness with flexibility for a distinctive equipment‑carrying effect. A variety of track options are available, offering strong adaptability to different terrains.

### 6.2 Technical Dimensions
...
| :--- | :---: | :--- | :---: |
| Overall dimensions (mm) | 1416 × 800 × 544 | Internal compartment size (including battery) | 460 × 360 × 345 |
| Chassis weight (unloaded) | 150 kg | Operating speed | 0 – 7.5 km/h |
| Ground clearance | 180 mm | Protection rating | IP64 |
| Max gap crossing | 400 mm | Maximum payload | 150 kg |
| Max climbing angle | 30° (capable of climbing stairs) | Vertical obstacle clearance | 400 mm |
...
| Rated torque | 60 N·m | Gear ratio | 12 |
...
| Max total power | 2000 W × 2 | Standby power consumption | ≤ 50 W |
| Brake type (optional) | Power‑off braking type | Brake voltage | DC 48 V |
| Encoder | 1024 P | Driver model | JCDBL6075‑2E |
| Remote control range | 200 m (line‑of‑sight) | Remote control channels | 9T (2 used) |
| Chassis total weight | 200 kg | Chassis total current | 58 A |
...
| **Battery** | | | |
| :--- | :--- | :--- | :--- |
| Nominal voltage | 48 V | Rated capacity | 50 Ah |
| Charge cut‑off | 54.6 V ± 0.2 V | Discharge cut‑off | 39 V |
| Discharge current | 100 A | Operating temperature | -10°C to +60°C (discharge), 0‑45°C (charge) |
...
<img width="1072" height="805" alt="image" src="https://github.com/user-attachments/assets/56a488ad-686f-42d0-b7f5-3a3f75939340" />

a) **Battery**: Standard 48V 50Ah lithium battery, maximum voltage 54.6V, cut‑off discharge voltage 39V.  
...
c) **Main relay:** Coil voltage 48V, main contact current 150A, normal temperature rise 60°C.
...
- Place the chassis frame on a stand, lifting the track suspension approximately 50 mm off the ground.
- Release the front swing arm by loosening the front pivot fastening screws.

<img width="906" height="524" alt="image" src="https://github.com/user-attachments/assets/232a3426-8b79-42d2-bdf0-b412bb854500" />

- Rotate the front swing arm downward by 90° to release track tension.

<img width="854" height="491" alt="image" src="https://github.com/user-attachments/assets/0a104c43-f325-4280-bcc0-2307eb9c7a3b" />

- Remove the track from the suspension assembly.
- Install the new track in the reverse order (pay attention to tread direction), then tighten the upper shock absorber pivot screws.
- Power on and drive the chassis slowly to check that both tracks run consistently.

c. **Lubricating oil replacement:**

The reducer assembly in this chassis is designed for **lifelong lubrication**. Under normal operating conditions, no lubricating oil replacement is required. Do not disassemble the reducer without authorisation.
...
<img width="1425" height="1101" alt="image" src="https://github.com/user-attachments/assets/255e54a3-75e6-4a43-9fbc-70ea1c1fa8b9" />

*Please open this page in a browser and download:*

[K04_Customer_Communication.zip](https://www.yuque.com/attachments/yuque/0/2023/zip/2802136/1686551993317-e6c53200-3cee-4668-8771-33c078311690.zip)
...
> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/kcfq2c0kvw65k7gf](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/kcfq2c0kvw65k7gf)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/evbbxo35q1lq7gq2](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/evbbxo35q1lq7gq2)
